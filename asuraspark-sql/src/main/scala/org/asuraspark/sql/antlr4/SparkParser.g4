 ...
 *
 * This file is an adaptation of Presto's presto-parser/src/main/antlr4/com/facebook/presto/sql/parser/SparkParser.g4 grammar.
 */
...
statement
    ...
    | MERGE TABLE (IF NOT EXISTS)? tableIdentifier partitionSpec?      #mergeTable
